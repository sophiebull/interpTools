...
This vignette will demonstrate the appropriate workflow for steps 1-4.  The example code is that which was used to generate the built-in 'toy data' contained in this package.
...
GappyData <- simulateGaps(data = OriginalData, prop_vec = prop_vec, gap_vec = gap_vec, K = 10)
```
