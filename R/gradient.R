  ...
  for(s in 1:C){
    for(vm in 1:M){
      for(vd in 1:D){
        ...
        slope_ldd <- function(critMat,i,j){
          vals <- list()
        ...
        slope_rdd <- function(critMat,i,j){
          vals <- list()
        ...
        slope_rud <- function(critMat,i,j){
          vals <- list()
        ...
        slope_lud <- function(critMat,i,j){
          vals <- list()
        ...
        for(i in 1:I){
          for(j in 1:J){
            ...
            if(scheme[i,j] == "tlcorner"){
              ...
              vals1 <- slope_l(critMat,i,j)
              vars1 <- c(vals1$x1,vals1$y1,vals1$z1,vals1$x2,vals1$y2,vals1$z2)
              
              vals2 <- slope_ldd(critMat,i,j)
              vars2 = c(vals2$x1,vals2$y1,vals2$z1,vals2$x2,vals2$y2,vals2$z2)
              
              vals3 <- slope_d(critMat,i,j)
              vars3 = c(vals3$x1,vals3$y1,vals3$z1,vals3$x2,vals3$y2,vals3$z2)
              
              vals4 <- slope_rdd(critMat,i,j)
              vars4 = c(vals4$x1,vals4$y1,vals4$z1,vals4$x2,vals4$y2,vals4$z2)
              
              vals5 <- slope_r(critMat,i,j)
              ...
              vals4 <- slope_rud(critMat,i,j)
              vars4 = c(vals4$x1,vals4$y1,vals4$z1,vals4$x2,vals4$y2,vals4$z2)
              
              vals5 <- slope_u(critMat,i,j)
              vars5 = c(vals5$x1,vals5$y1,vals5$z1,vals5$x2,vals5$y2,vals5$z2)
              ...
              vals4 <- slope_u(critMat,i,j)
              vars4  = c(vals4$x1,vals4$y1,vals4$z1,vals4$x2,vals4$y2,vals4$z2)
              
              vals5 <- slope_lud(critMat,i,j)
              vars5  = c(vals5$x1,vals5$y1,vals5$z1,vals5$x2,vals5$y2,vals5$z2)
              ...
              vals1 <- slope_r(critMat,i,j)
              vars1 = c(vals1$x1,vals1$y1,vals1$z1,vals1$x2,vals1$y2,vals1$z2)
              
              vals2 <- slope_rud(critMat,i,j)
              vars2 = c(vals2$x1,vals2$y1,vals2$z1,vals2$x2,vals2$y2,vals2$z2)
              
              vals3 <- slope_u(critMat,i,j)
              vars3 = c(vals3$x1,vals3$y1,vals3$z1,vals3$x2,vals3$y2,vals3$z2)
              ...
              vals2 <- slope_r(critMat,i,j)
              vars2 = c(vals2$x1,vals2$y1,vals2$z1,vals2$x2,vals2$y2,vals2$z2)
              
              vals3 <- slope_rud(critMat,i,j)
              vars3 = c(vals3$x1,vals3$y1,vals3$z1,vals3$x2,vals3$y2,vals3$z2)
              ...
              vals2 <- slope_u(critMat,i,j)
              vars2 = c(vals2$x1,vals2$y1,vals2$z1,vals2$x2,vals2$y2,vals2$z2)
              
              vals3 <- slope_lud(critMat,i,j)
              vars3 = c(vals3$x1,vals3$y1,vals3$z1,vals3$x2,vals3$y2,vals3$z2)
