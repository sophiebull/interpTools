...
#' \item minimum (0\% quantile)
#' \item 2.5\% quantile
#' \item 25\% quantile
#' \item median (50\% quantile)
#' \item 75\% quantile
#' \item 97.5\% quantile
#' \item maximum (100\% quantile)
#' \item IQR (97.5\% quantile - 2.5\% quantile)
#' \item skewness
#' \item p-value of dip test for unimodality (see \code{?dip} for details)
#' }
