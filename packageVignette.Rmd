...
The result is a nested list of dimension $D\times P \times G \times K$, saved as `~/toyData/toy_GappyData.rda`. The data structure can be visualized as:
...
The resulting object is a nested list of dimension $D \times M \times P \times G \times K$, saved as `~/toyData/toy_IntData.rda`. The structure of the data can be visualized as:
...
The resulting data structure can be visualized as:
...
```{r plotXtcpt, cache = TRUE, fig.width = 6, fig.height = 7, fig.align = "center"}
...
```{r heatmapGrid2, cache = TRUE, fig.width = 4, fig.height = 4, fig.align = "center"}
heatmapGrid2(d = 1, 
             agEval = agEval, 
             f = "median", 
             crit = c("MSE"), 
...
```{r heatmapGrid2_d, cache = TRUE, fig.width = 6, fig.height = 4, fig.align = "center"}
...
```{r multiHeatmap_crit, cache = TRUE, fig.width = 6, fig.height = 5, fig.align = "center"}
...
```{r multiHeatmap_method, cache = TRUE, fig.width = 6, fig.height = 5, fig.align = "center"}
...
```{r plotCS_g, cache = TRUE, fig.width = 6, fig.height = 6, fig.align = "center"}
p <- plotCS(d = 1,
       m = c("LI","NN","EWMA"),
       crit = "MSE", 
       agEval = agEval, 
...
```{r plotCS_p, cache = TRUE, fig.width = 6, fig.height = 6, fig.align = "center"}
p <- plotCS(d = 1,
       m = c("LI","NN","EWMA"),
       crit = "MSE", 
       agEval = agEval, 
...
```{r multiCS_d, cache = TRUE, fig.width = 8, fig.height = 10, fig.align = "center"}
multiCS(d = 1:5,
        agEval = agEval,
        m = c("LI","NN","EWMA"), 
        crit = "MSE", 
...
```{r multiCS_m, cache = TRUE, fig.width = 8, fig.height = 6, fig.align = "center"}
multiCS(d = 1:5,
        agEval = agEval,
        m = c("LI","NN","EWMA"), 
        crit = "MSE", 
...
```{r plotCS_un_p, cache = TRUE, fig.width = 6, fig.height = 8, fig.align = "center"}
plotCS_un(d = 1,
          agEval = agEval,
          cross_section = "p", 
          crit = "MSE", 
