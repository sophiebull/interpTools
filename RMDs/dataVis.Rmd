...
# get z_list
z_list <- plotSurface(crit=c("MAPE","NRMSD"), agEval = testag, layer_type = "method", f="median", output = "raw")
...
```{r}
ps<- plotSurface(crit=c("MAPE","NRMSD"), agEval = testag, layer_type = "method", f="median", output = "plots")
...
# get z_list
z_list <- plotSurface(crit=c("MAPE","NRMSD"), agEval = testag, layer_type = "dataset", f="median", output = "raw")
...
SURFACE PLOTS (WITHOUT SPLINES)
```{r}
PS <- plotSurface(crit=c("MAPE","NRMSD"), m = 4:6, agEval = testag, layer_type = "dataset", f = "median", output = "plots")
...
CROSS_SECTION = P
```{r}
plotListCS <- plotCS(m = 4:6, agEval = testag, cross_section = "p", layer_type = "method", crit = c("MAPE","NRMSD"))
