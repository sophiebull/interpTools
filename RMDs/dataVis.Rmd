...
# WITH SPLINES
new.ag <- load_obj("/home/sophie/sophTools/files/new_1/new.ag.rda")
multiSurface(crit="NRMSD", agEval = new.ag, layer_type = "method", m = c("HWI","KAF","EWMA","FMM", "HCS", "NCS"), f="median", highlight = "HWI", highlight_color = "#F92111", colors = c("#F9E0AA","#FAAF08","#FA812F"), d = 1:5)
```

```{r}
# WITHOUT SPLINES (DEFAULT)
new.ag <- load_obj("/home/sophie/sophTools/files/new_1/new.ag.rda")
multiSurface(crit="NRMSD", agEval = new.ag, layer_type = "method", m = c("HWI","KAF","EWMA"), f="median", highlight = "HWI", highlight_color = "#F92111", colors = c("#F9E0AA","#FAAF08","#FA812F"), d = 1:5)
```
...
# WITH SPLINES
new.ag <- load_obj("/home/sophie/sophTools/files/new_1/new.ag.rda")
multiSurface(crit="NRMSD", agEval = new.ag, layer_type = "dataset", m = c("HWI","KAF","EWMA","FMM", "HCS", "NCS"), f="median", highlight = 1, highlight_color = "#F92111", colors = c("#F9E0AA","#FAAF08","#FA812F"), d = 1:5)
```

```{r}
# WITHOUT SPLINES (DEFAULT)
new.ag <- load_obj("/home/sophie/sophTools/files/new_1/new.ag.rda")
multiSurface(crit="NRMSD", agEval = new.ag, layer_type = "dataset", m = c("HWI","KAF","EWMA"), f="median", highlight = 1, highlight_color = "#F92111", colors = c("#F9E0AA","#FAAF08","#FA812F"), d = 1:5)
```

# HEATMAPS
```{r}
setwd("/home/sophie/sophTools/files/new_1")
png("NRMSD_heatmap.png", width = 1000, height = 1000)
multiHeatmap(crit = "NRMSD", by = "method", m = c("HWI","KAF","EWMA"), agEval = new.ag)
dev.off()

png("RMSE_heatmap.png", width = 1000, height = 1000)
multiHeatmap(crit = "RMSE", by = "method", m = c("HWI","KAF","EWMA"), agEval = new.ag)
dev.off()

png("MAPE_heatmap.png", width = 1000, height = 1000)
multiHeatmap(crit = "MAPE", by = "method", m = c("HWI","KAF","EWMA"), agEval = new.ag)
dev.off()

png("MdAPE_heatmap.png", width = 1000, height = 1000)
multiHeatmap(crit = "MdAPE", by = "method", m = c("HWI","KAF","EWMA"), agEval = new.ag)
dev.off()
```
